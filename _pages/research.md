...
### [Poor housing quality and the health of newborns and young children](https://www.nature.com/articles/s41598-024-63789-z#Abs1)
*(joint work with Tamás Hajdu and Gábor Kertesi)*
...
### [Mechanisms of Learning in Collaborative Jobs](/files/bekes_szabo_mechanisms_current.pdf)
*(joint work with Gábor Békés)*

How do workers learn from their coworkers in the workplace, especially when collaboration is essential? We investigate the mechanisms of learning in a high-skill collaborative environment: top teams in European men's football. We start by confirming the positive effect of coworker quality found in administrative data. Our setting is conducive to finding evidence of learning as it can compare players in very similar units of soccer squads. To reduce sorting fears, we augment wages by market values as our human capital estimate, and we show that we capture human capital evolution with less bias. We first confirm existing evidence on peer effects: wage growth is faster in better teams. Second, we show that given average peer quality, talent composition does not play a role. Third, having a more important role on the team -- more minutes -- correlates strongly with learning. Moreover, it is a confounder leading to underestimated learning in its absence. Fourth, our detailed data allows for examining details of collaboration. We find that intensive collaboration with high-quality peers matters the most. Additionally, we corroborate the wage growth findings by examining the evolution of relevant skill attributes as well: learnable skills improve due to better peers while non-learnable skills are not related. Finally we separate individual development from team complementarities, showing that higher accumulated skills persist even when workers change jobs.

### [The Impact of Childcare on Maternal Employment](https://kti.krtk.hu/wp-content/uploads/2022/10/CERSIEWP202220.pdf)
*(joint work with Judit Berei, Márton Csillag, Hanna Erős, Judit Krekó, Ágota Scharle, 2022)*
...
### [Tax Incentives and Completed Fertility](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4624859)
*(Job Market Paper)*
...
### [Charitable Behavior and Public Intervention: a Survey Experiment](/files/leombroni_szabo_charity_current.pdf)
*(joint work with Francesca Leombroni)*
...
### [Housing and Fertility](/files/bence_szabo_fertility_housing_current.pdf)
...
### [Measuring the Influence of Coaches on NBA Players' Development, with Spillovers](/files/bence_szabo_StatMethods_termpaper.pdf)
*(Data Science Term Project, 2017)*
